...
approveForMyOrg() {
  ...
  { set +x; } 2>/dev/null
  cat log.txt
  verifyResult $res "Chaincode definition approved on peer${PEER}.org1 1on channel '$CHANNEL_NAME' failed"
...
commitChaincodeDefinition() {
  ...
  { set +x; } 2>/dev/null
  cat log.txt
  verifyResult $res "Chaincode definition commit failed on org${PEER} on channel '$CHANNEL_NAME' failed"
...
infoln "queryInstalled chaincode on peer0.org1..."
queryInstalled 0
infoln "queryInstalled chaincode on peer1.org1..."
queryInstalled 1


infoln "approveForMyOrg chaincode..."
approveForMyOrg 0

infoln "commitChaincodeDefinition"
commitChaincodeDefinition 0 1

infoln "queryCommitted on peer0.org1..."
queryCommitted 0
infoln "queryCommitted on peer1.org1..."
queryCommitted 1
